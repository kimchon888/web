...
public class Product {
    ...
    public String getTragop() { return tragop; }
    public void setTragop(String tragop) { this.tragop = tragop; }
    ...
    public double getPricesgoc() { return pricesgoc; }
    public void setPricesgoc(double pricesgoc) { this.pricesgoc = pricesgoc; }
    ...
    public String getBaiviet() { return baiviet; }
    public void setBaiviet(String baiviet) { this.baiviet = baiviet; }
